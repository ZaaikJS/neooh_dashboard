    ...
    return (
        <div className="flex justify-center m-4 mt-28">
            <div className="flex flex-col justify-center items-center gap-8 p-8">
                ...
                <div
                    className="px-6 py-2 flex items-center gap-4 bg-white border-2 border-gray-300 rounded-full shadow-lg shadow-black/40 hover:shadow-xl duration-200 cursor-pointer"
